...
class PHPExcel_Calculation_Engineering
{
    ...
    public static function COMPLEX($realNumber = 0.0, $imaginary = 0.0, $suffix = 'i')
    {
        ...
        if (((is_numeric($realNumber)) && (is_numeric(
                    $imaginary
    ...
    public static function IMABS($complexNumber)
    {
        ...
        return sqrt(
            ($parsedComplex['real'] * $parsedComplex['real']) + ($parsedComplex['imaginary'] * $parsedComplex['imaginary'])
        );
    } //	function IMABS()
    ...
    public static function IMCONJUGATE($complexNumber)
    {
        ...
        if ($parsedComplex['imaginary'] == 0.0) {
            ...
            return self::_cleanComplex(
                self::COMPLEX($parsedComplex['real'], 0 - $parsedComplex['imaginary'], $parsedComplex['suffix'])
            );
        }
