...
class PHPExcel_Calculation_MathTrig
{
    ...
    public static function ATAN2($xCoordinate = null, $yCoordinate = null)
    {
        ...
        if (((is_numeric($xCoordinate)) || (is_bool($xCoordinate))) && ((is_numeric($yCoordinate))) || (is_bool(
                $yCoordinate
            ))) {
    ...
    public static function CEILING($number, $significance = null)
    {
        ...
        if ((is_null($significance)) && (PHPExcel_Calculation_Functions::getCompatibilityMode(
    ...
    public static function SUMX2MY2($matrixData1, $matrixData2)
    {
        ...
        $result = 0;
        for ($i = 0; $i < $count; ++$i) {
            if (((is_numeric($array1[$i])) && (!is_string($array1[$i]))) && ((is_numeric($array2[$i])) && (!is_string(
                        $array2[$i]
                    )))) {
