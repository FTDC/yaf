...
class PHPExcel_Calculation_Statistical
{
    ...
    public static function AVEDEV()
    {
        ...
        if ($aMean != PHPExcel_Calculation_Functions::DIV0()) {
            ...
            foreach ($aArgs as $k => $arg) {
                if ((is_bool($arg)) && ((!PHPExcel_Calculation_Functions::isCellValue(
                            $k
    ...
    public static function BETADIST($value, $alpha, $beta, $rMin = 0, $rMax = 1)
    {
        ...
        if ((is_numeric($value)) && (is_numeric($alpha)) && (is_numeric($beta)) && (is_numeric($rMin)) && (is_numeric(
                $rMax
            ))) {
    ...
    public static function BETAINV($probability, $alpha, $beta, $rMin = 0, $rMax = 1)
    {
        ...
        if ((is_numeric($probability)) && (is_numeric($alpha)) && (is_numeric($beta)) && (is_numeric(
                $rMin
            )) && (is_numeric($rMax))) {
        ...
        if ((is_numeric($value)) && (is_numeric($trials)) && (is_numeric($probability))) {
            ...
            if ((is_numeric($cumulative)) || (is_bool($cumulative))) {
                if ($cumulative) {
                    $summer = 0;
                    for ($i = 0; $i <= $value; ++$i) {
                        $summer += PHPExcel_Calculation_MathTrig::COMBIN($trials, $i) * pow($probability, $i) * pow(
                                1 - $probability,
                                $trials - $i
                            );
                    }
                    ...
                    return PHPExcel_Calculation_MathTrig::COMBIN($trials, $value) * pow($probability, $value) * pow(
                            1 - $probability,
                            $trials - $value
                        );
                }
    ...
    public static function HYPGEOMDIST($sampleSuccesses, $sampleNumber, $populationSuccesses, $populationNumber)
    {
        ...
        if ((is_numeric($sampleSuccesses)) && (is_numeric($sampleNumber)) && (is_numeric(
                $populationSuccesses
            ...
            return PHPExcel_Calculation_MathTrig::COMBIN(
                    $populationSuccesses,
                    $sampleSuccesses
    ...
    public static function KURT()
    {
        ...
        if ($stdDev > 0) {
            ...
            // Return
            if ($count > 3) {
                return $summer * ($count * ($count + 1) / (($count - 1) * ($count - 2) * ($count - 3))) - (3 * pow(
                            $count - 1,
                            2
                        ) / (($count - 2) * ($count - 3)));
            }
    ...
    public static function NEGBINOMDIST($failures, $successes, $probability)
    {
        ...
        if ((is_numeric($failures)) && (is_numeric($successes)) && (is_numeric($probability))) {
            ...
            return (PHPExcel_Calculation_MathTrig::COMBIN($failures + $successes - 1, $successes - 1)) * (pow(
                    $probability,
                    $successes
    ...
    public static function NORMDIST($value, $mean, $stdDev, $cumulative)
    {
        ...
        if ((is_numeric($value)) && (is_numeric($mean)) && (is_numeric($stdDev))) {
            ...
            if ((is_numeric($cumulative)) || (is_bool($cumulative))) {
                if ($cumulative) {
                    return 0.5 * (1 + PHPExcel_Calculation_Engineering::_erfVal(
                                ($value - $mean) / ($stdDev * sqrt(2))
                            ));
                } else {
    ...
    public static function PERCENTRANK($valueSet, $value, $significance = 3)
    {
        ...
        $value = PHPExcel_Calculation_Functions::flattenSingleValue($value);
        $significance = (is_null($significance)) ? 3 : (integer)PHPExcel_Calculation_Functions::flattenSingleValue(
            $significance
        );
    ...
    public static function PERMUT($numObjs, $numInSet)
    {
        ...
        if ((is_numeric($numObjs)) && (is_numeric($numInSet))) {
            ...
            return round(
                PHPExcel_Calculation_MathTrig::FACT($numObjs) / PHPExcel_Calculation_MathTrig::FACT(
                    $numObjs - $numInSet
                )
            );
        }
        ...
        if ((is_numeric($value)) && (is_numeric($alpha)) && (is_numeric($beta))) {
            ...
            if ((is_numeric($cumulative)) || (is_bool($cumulative))) {
                if ($cumulative) {
                    ...
                    return ($alpha / pow($beta, $alpha)) * pow($value, $alpha - 1) * exp(
                            0 - pow($value / $beta, $alpha)
                        );
                }
            }
        }
