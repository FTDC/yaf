    ...
    public function loadIntoExisting($pFilename, PHPExcel $objPHPExcel)
    {
                    ...
                    case 'user-defined' :
                        ...
                        foreach ($propertyValueAttributes as $key => $value) {
                            if ($key == 'name') {
                                ...
                                switch ($value) {
                                    case 'date'    :
                                        $propertyValue = PHPExcel_DocumentProperties::convertProperty(
                                            $propertyValue,
                                            'date'
                                        );
        ...
        foreach ($workbook->body->spreadsheet as $workbookData) {
            ...
            foreach ($workbookData->table as $worksheetDataSet) {
                ...
                //				echo '<br />';
                if ((isset($this->_loadSheetsOnly)) && (isset($worksheetDataAttributes['name'])) && (!in_array(
                        $worksheetDataAttributes['name'],
                    ...
                    switch ($key) {
                        ...
                        case 'table-row' :
                            ...
                            foreach ($rowData as $key => $cellData) {
                                ...
                                $cellDataText = (isset($namespacesContent['text'])) ? $cellData->children(
                                    ...
                                    switch ($cellDataOfficeAttributes['value-type']) {
                                        case 'string' :
                                            ...
                                            if (isset($dataValue->a)) {
                                                ...
                                                $cellXLinkAttributes = $dataValue->attributes(
                                                    $namespacesContent['xlink']
                                                );
                                        ...
                                        case 'date' :
                                            ...
                                            $dataValue = PHPExcel_Shared_Date::FormattedPHPToExcel(
                                                $year,
                                                $month,
                                                $day,
                                                $hour,
                                        ...
                                        case 'time' :
                                            $type = PHPExcel_Cell_DataType::TYPE_NUMERIC;
                                            $dataValue = PHPExcel_Shared_Date::PHPToExcel(
                                                strtotime(
                                                    '01-01-1970 '.implode(
                                                        ':',
                                ...
                                if ($hasCalculatedValue) {
                                    ...
                                    foreach ($temp as &$value) {
                                        ...
                                        if ($tKey = !$tKey) {
                                            ...
                                            $value = PHPExcel_Calculation::_translateSeparator(
                                                ';',
                                                ',',
                                                $value,
                                                $inBraces
                                            ...
                                            for ($rowAdjust = 0; $rowAdjust < $rowRepeats; ++$rowAdjust) {
                                                ...
                                                if ($formatting !== null) {
                                                    $objPHPExcel->getActiveSheet()->getStyle(
                                                        $columnID.$rID
                                                    )->getNumberFormat()->setFormatCode($formatting);
                                                } else {
                                                    $objPHPExcel->getActiveSheet()->getStyle(
                                                        $columnID.$rID
                                ...
                                if ((isset($cellDataTableAttributes['number-columns-spanned'])) || (isset($cellDataTableAttributes['number-rows-spanned']))) {
                                    if (($type !== PHPExcel_Cell_DataType::TYPE_NULL) || (!$this->_readDataOnly)) {
                                        ...
                                        if (isset($cellDataTableAttributes['number-columns-spanned'])) {
                                            $columnTo = PHPExcel_Cell::stringFromColumnIndex(
                                                PHPExcel_Cell::columnIndexFromString(
                                                    $columnID
                                                ) + $cellDataTableAttributes['number-columns-spanned'] - 2
                                            );
                                        }
                                        $rowTo = $rowID;
