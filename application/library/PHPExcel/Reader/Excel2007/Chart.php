...
class PHPExcel_Reader_Excel2007_Chart
{
                            ...
                            case "plotArea":
                                ...
                                foreach ($chartDetails as $chartDetailKey => $chartDetail) {
                                    switch ($chartDetailKey) {
                                        case "layout":
                                            $plotAreaLayout = self::_chartLayoutDetails(
                                                $chartDetail,
                                                $namespacesChartMeta,
                                                'plotArea'
                                            );
                                        ...
                                        case "lineChart":
                                        case "line3DChart":
                                            $plotSeries[] = self::_chartDataSeries(
                                                $chartDetail,
                                                $namespacesChartMeta,
                                                $chartDetailKey
                                            );
                                        ...
                                        case "pie3DChart":
                                            ...
                                            break;
                                        case "scatterChart":
                                            $scatterStyle = self::_getAttribute(
                                                $chartDetail->scatterStyle,
                                                'val',
                                                'string'
                                            );
                                            $plotSer = self::_chartDataSeries(
                                            ...
                                            break;
                                        case "bubbleChart":
                                            $bubbleScale = self::_getAttribute(
                                                $chartDetail->bubbleScale,
                                                'val',
                                                'integer'
                                            );
                                            $plotSer = self::_chartDataSeries(
                                            ...
                                            break;
                                        case "radarChart":
                                            $radarStyle = self::_getAttribute(
                                                $chartDetail->radarStyle,
                                                'val',
                                                'string'
                                            );
                                            $plotSer = self::_chartDataSeries(
                                ...
                                foreach ($chartDetails as $chartDetailKey => $chartDetail) {
                                    switch ($chartDetailKey) {
                                        ...
                                        case "overlay":
                                            ...
                                            break;
                                        case "layout":
                                            $legendLayout = self::_chartLayoutDetails(
                                                $chartDetail,
                                                $namespacesChartMeta,
                                                'legend'
                                            );
                    ...
                    foreach ($seriesDetails as $seriesKey => $seriesDetail) {
                        switch ($seriesKey) {
                            ...
                            case "order":
                                ...
                                break;
                            case "tx":
                                $seriesLabel[$seriesIndex] = self::_chartDataSeriesValueSet(
                                    $seriesDetail,
                                    $namespacesChartMeta
                                );
                                break;
                            ...
                            case "smooth":
                                ...
                                break;
                            case "cat":
                                $seriesCategory[$seriesIndex] = self::_chartDataSeriesValueSet(
                                    $seriesDetail,
                                    $namespacesChartMeta
                                );
                                break;
                            case "val":
                                $seriesValues[$seriesIndex] = self::_chartDataSeriesValueSet(
                                    $seriesDetail,
                                    $namespacesChartMeta,
                                    $marker
                                );
    ...
    private static function _chartDataSeriesValueSet(
        $seriesDetail,
        $namespacesChartMeta,
        $marker = null,
        $smoothLine = false
        ...
        if (isset($seriesDetail->strRef)) {
            ...
            $seriesData = self::_chartDataSeriesValues(
                $seriesDetail->strRef->strCache->children($namespacesChartMeta['c']),
                's'
            );
            ...
            $seriesData = self::_chartDataSeriesValues(
                $seriesDetail->numRef->numCache->children($namespacesChartMeta['c'])
            );
            ...
            $seriesData = self::_chartDataSeriesValuesMultiLevel(
    ...
    private static function _readChartAttributes($chartDetail)
    {
        ...
        if (isset($chartDetail->dLbls)) {
            if (isset($chartDetail->dLbls->howLegendKey)) {
                $plotAttributes['showLegendKey'] = self::_getAttribute(
                    $chartDetail->dLbls->showLegendKey,
                    'val',
                    'string'
                );
            }
            ...
            if (isset($chartDetail->dLbls->showBubbleSize)) {
                $plotAttributes['showBubbleSize'] = self::_getAttribute(
                    $chartDetail->dLbls->showBubbleSize,
                    'val',
                    'string'
                );
            }
            if (isset($chartDetail->dLbls->showLeaderLines)) {
                $plotAttributes['showLeaderLines'] = self::_getAttribute(
                    $chartDetail->dLbls->showLeaderLines,
                    'val',
                    'string'
                );
            }
