 ...
 */
class Taobao_Request_DeliveryTemplateAddRequest
{
    /**
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkNotNull($this->assumer, "assumer");
        Taobao_RequestCheckUtil::checkNotNull($this->name, "name");
        Taobao_RequestCheckUtil::checkMaxLength($this->name, 50, "name");
        Taobao_RequestCheckUtil::checkNotNull($this->templateAddFees, "templateAddFees");
        Taobao_RequestCheckUtil::checkNotNull($this->templateAddStandards, "templateAddStandards");
        Taobao_RequestCheckUtil::checkNotNull($this->templateDests, "templateDests");
        Taobao_RequestCheckUtil::checkNotNull($this->templateStartFees, "templateStartFees");
        Taobao_RequestCheckUtil::checkNotNull($this->templateStartStandards, "templateStartStandards");
        Taobao_RequestCheckUtil::checkNotNull($this->templateTypes, "templateTypes");
        Taobao_RequestCheckUtil::checkNotNull($this->valuation, "valuation");
    }
