 ...
 */
class Taobao_Request_InventoryStoreManageRequest
{
    /**
     * 仓库的物理地址，可更新
     **/
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkNotNull($this->addressAreaName, "addressAreaName");
        Taobao_RequestCheckUtil::checkNotNull($this->operateType, "operateType");
        Taobao_RequestCheckUtil::checkNotNull($this->storeCode, "storeCode");
        Taobao_RequestCheckUtil::checkNotNull($this->storeName, "storeName");
        Taobao_RequestCheckUtil::checkNotNull($this->storeType, "storeType");
    }
