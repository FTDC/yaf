...
class Taobao_Request_LogisticsAddressAddRequest
{
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkNotNull($this->contactName, "contactName");
        Taobao_RequestCheckUtil::checkMaxLength($this->memo, 256, "memo");
        Taobao_RequestCheckUtil::checkNotNull($this->province, "province");
        Taobao_RequestCheckUtil::checkMaxLength($this->sellerCompany, 20, "sellerCompany");
    }
