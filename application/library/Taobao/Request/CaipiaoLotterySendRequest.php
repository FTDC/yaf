 ...
 */
class Taobao_Request_CaipiaoLotterySendRequest
{
    /**
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkNotNull($this->buyerNumId, "buyerNumId");
        Taobao_RequestCheckUtil::checkNotNull($this->sellerNumId, "sellerNumId");
        Taobao_RequestCheckUtil::checkNotNull($this->stakeCount, "stakeCount");
    }
