 ...
 */
class Taobao_Request_FenxiaoRefundCreateRequest
{
    /**
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkNotNull($this->isReturnGoods, "isReturnGoods");
        Taobao_RequestCheckUtil::checkNotNull($this->isReturnPostFee, "isReturnPostFee");
        Taobao_RequestCheckUtil::checkNotNull($this->refundDesc, "refundDesc");
        Taobao_RequestCheckUtil::checkNotNull($this->refundReasonId, "refundReasonId");
        Taobao_RequestCheckUtil::checkNotNull($this->returnFee, "returnFee");
