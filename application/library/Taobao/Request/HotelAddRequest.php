 ...
 */
class Taobao_Request_HotelAddRequest
{
    /**
     * 酒店地址。长度不能超过120
     **/
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkMaxLength($this->address, 120, "address");
        Taobao_RequestCheckUtil::checkNotNull($this->city, "city");
        Taobao_RequestCheckUtil::checkMaxValue($this->city, 999999, "city");
        Taobao_RequestCheckUtil::checkMinValue($this->city, 0, "city");
        Taobao_RequestCheckUtil::checkNotNull($this->country, "country");
        Taobao_RequestCheckUtil::checkMaxLength($this->decorateTime, 4, "decorateTime");
        Taobao_RequestCheckUtil::checkNotNull($this->desc, "desc");
        Taobao_RequestCheckUtil::checkMaxLength($this->desc, 50000, "desc");
        Taobao_RequestCheckUtil::checkMaxValue($this->district, 999999, "district");
        Taobao_RequestCheckUtil::checkMinValue($this->district, 0, "district");
        Taobao_RequestCheckUtil::checkNotNull($this->domestic, "domestic");
        Taobao_RequestCheckUtil::checkNotNull($this->level, "level");
        Taobao_RequestCheckUtil::checkMaxLength($this->level, 1, "level");
        Taobao_RequestCheckUtil::checkNotNull($this->name, "name");
        Taobao_RequestCheckUtil::checkMaxLength($this->name, 60, "name");
        Taobao_RequestCheckUtil::checkMaxLength($this->openingTime, 4, "openingTime");
        Taobao_RequestCheckUtil::checkNotNull($this->orientation, "orientation");
        Taobao_RequestCheckUtil::checkMaxLength($this->orientation, 1, "orientation");
        Taobao_RequestCheckUtil::checkNotNull($this->pic, "pic");
        Taobao_RequestCheckUtil::checkNotNull($this->province, "province");
        Taobao_RequestCheckUtil::checkMaxValue($this->province, 999999, "province");
        Taobao_RequestCheckUtil::checkMinValue($this->province, 0, "province");
        Taobao_RequestCheckUtil::checkMaxValue($this->rooms, 9999, "rooms");
        Taobao_RequestCheckUtil::checkMinValue($this->rooms, 0, "rooms");
        Taobao_RequestCheckUtil::checkMaxLength($this->siteParam, 100, "siteParam");
        Taobao_RequestCheckUtil::checkMaxValue($this->storeys, 9999, "storeys");
        Taobao_RequestCheckUtil::checkMinValue($this->storeys, 0, "storeys");
        Taobao_RequestCheckUtil::checkMaxLength($this->tel, 32, "tel");
    }
