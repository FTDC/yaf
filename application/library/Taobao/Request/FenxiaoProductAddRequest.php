...
class Taobao_Request_FenxiaoProductAddRequest
{
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkNotNull($this->alarmNumber, "alarmNumber");
        ...
        Taobao_RequestCheckUtil::checkNotNull($this->haveGuarantee, "haveGuarantee");
        Taobao_RequestCheckUtil::checkNotNull($this->haveInvoice, "haveInvoice");
        Taobao_RequestCheckUtil::checkNotNull($this->name, "name");
        Taobao_RequestCheckUtil::checkNotNull($this->postageType, "postageType");
        Taobao_RequestCheckUtil::checkNotNull($this->productcatId, "productcatId");
        Taobao_RequestCheckUtil::checkNotNull($this->prov, "prov");
        Taobao_RequestCheckUtil::checkNotNull($this->quantity, "quantity");
        Taobao_RequestCheckUtil::checkNotNull($this->retailPriceHigh, "retailPriceHigh");
        Taobao_RequestCheckUtil::checkNotNull($this->retailPriceLow, "retailPriceLow");
        Taobao_RequestCheckUtil::checkNotNull($this->standardPrice, "standardPrice");
    }
