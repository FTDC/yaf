...
class Taobao_Request_FenxiaoOrderCreateDealerRequest
{
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkNotNull($this->addr, "addr");
        Taobao_RequestCheckUtil::checkNotNull($this->buyerName, "buyerName");
        Taobao_RequestCheckUtil::checkMaxLength($this->buyerName, 20, "buyerName");
        Taobao_RequestCheckUtil::checkNotNull($this->logisticFee, "logisticFee");
        Taobao_RequestCheckUtil::checkNotNull($this->logisticType, "logisticType");
        Taobao_RequestCheckUtil::checkMaxLength($this->message, 200, "message");
        Taobao_RequestCheckUtil::checkNotNull($this->outerId, "outerId");
        Taobao_RequestCheckUtil::checkNotNull($this->payType, "payType");
        Taobao_RequestCheckUtil::checkNotNull($this->province, "province");
        Taobao_RequestCheckUtil::checkNotNull($this->subOrderDetail, "subOrderDetail");
    }
