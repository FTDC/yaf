 ...
 */
class Taobao_Request_SubuserEmployeeAddRequest
{
    /**
     * 当前员工所属部门ID
     **/
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkNotNull($this->departmentId, "departmentId");
        Taobao_RequestCheckUtil::checkNotNull($this->employeeName, "employeeName");
        Taobao_RequestCheckUtil::checkNotNull($this->sex, "sex");
