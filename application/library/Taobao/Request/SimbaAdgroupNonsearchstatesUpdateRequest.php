 ...
 */
class Taobao_Request_SimbaAdgroupNonsearchstatesUpdateRequest
{
    /**
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkNotNull($this->adgroupidNonsearchstateJson, "adgroupidNonsearchstateJson");
