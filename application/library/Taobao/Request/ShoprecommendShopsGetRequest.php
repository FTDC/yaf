 ...
 */
class Taobao_Request_ShoprecommendShopsGetRequest
{
    /**
     * 请求个数，建议获取16个
     **/
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkNotNull($this->count, "count");
        Taobao_RequestCheckUtil::checkNotNull($this->recommendType, "recommendType");
        Taobao_RequestCheckUtil::checkNotNull($this->sellerId, "sellerId");
    }
