 ...
 */
class Taobao_Request_TradesSoldIncrementvGetRequest
{
    /**
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkNotNull($this->endCreate, "endCreate");
        Taobao_RequestCheckUtil::checkNotNull($this->fields, "fields");
        Taobao_RequestCheckUtil::checkNotNull($this->startCreate, "startCreate");
    }
