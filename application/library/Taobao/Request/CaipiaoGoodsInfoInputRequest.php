 ...
 */
class Taobao_Request_CaipiaoGoodsInfoInputRequest
{
    /**
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkNotNull($this->actEndDate, "actEndDate");
        Taobao_RequestCheckUtil::checkNotNull($this->actStartDate, "actStartDate");
        Taobao_RequestCheckUtil::checkNotNull($this->goodsId, "goodsId");
        Taobao_RequestCheckUtil::checkNotNull($this->goodsPrice, "goodsPrice");
        Taobao_RequestCheckUtil::checkNotNull($this->goodsType, "goodsType");
        Taobao_RequestCheckUtil::checkNotNull($this->lotteryTypeId, "lotteryTypeId");
        Taobao_RequestCheckUtil::checkNotNull($this->presentType, "presentType");
    }
