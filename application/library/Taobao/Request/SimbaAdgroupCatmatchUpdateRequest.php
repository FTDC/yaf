 ...
 */
class Taobao_Request_SimbaAdgroupCatmatchUpdateRequest
{
    /**
     * 推广组Id
     **/
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkNotNull($this->catmatchId, "catmatchId");
        Taobao_RequestCheckUtil::checkNotNull($this->maxPrice, "maxPrice");
        Taobao_RequestCheckUtil::checkMinValue($this->maxPrice, 5, "maxPrice");
        Taobao_RequestCheckUtil::checkNotNull($this->onlineStatus, "onlineStatus");
        Taobao_RequestCheckUtil::checkNotNull($this->useDefaultPrice, "useDefaultPrice");
    }
