 ...
 */
class Taobao_Request_FavoriteAddRequest
{
    /**
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkNotNull($this->itemNumid, "itemNumid");
        Taobao_RequestCheckUtil::checkMinValue($this->itemNumid, 1, "itemNumid");
    }
