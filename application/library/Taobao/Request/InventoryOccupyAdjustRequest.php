 ...
 */
class Taobao_Request_InventoryOccupyAdjustRequest
{
    /**
     * 商家外部订单号
     **/
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkNotNull($this->operateTime, "operateTime");
        Taobao_RequestCheckUtil::checkNotNull($this->tbOrderType, "tbOrderType");
    }
