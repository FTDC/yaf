 ...
 */
class Taobao_Request_AlipayEbppBillAddRequest
{
    /**
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkNotNull($this->billKey, "billKey");
        Taobao_RequestCheckUtil::checkMaxLength($this->billKey, 50, "billKey");
        Taobao_RequestCheckUtil::checkNotNull($this->chargeInst, "chargeInst");
        Taobao_RequestCheckUtil::checkMaxLength($this->chargeInst, 80, "chargeInst");
        ...
        Taobao_RequestCheckUtil::checkMaxLength($this->ownerName, 50, "ownerName");
        Taobao_RequestCheckUtil::checkNotNull($this->payAmount, "payAmount");
        Taobao_RequestCheckUtil::checkNotNull($this->subOrderType, "subOrderType");
        Taobao_RequestCheckUtil::checkMaxLength($this->subOrderType, 10, "subOrderType");
    }
