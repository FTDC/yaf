 ...
 */
class Taobao_Request_SimbaCampaignPlatformUpdateRequest
{
    /**
     * 推广计划Id
     **/
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkMaxListSize($this->nonsearchChannels, 10, "nonsearchChannels");
        Taobao_RequestCheckUtil::checkNotNull($this->outsideDiscount, "outsideDiscount");
        Taobao_RequestCheckUtil::checkMaxValue($this->outsideDiscount, 200, "outsideDiscount");
        Taobao_RequestCheckUtil::checkMinValue($this->outsideDiscount, 1, "outsideDiscount");
        Taobao_RequestCheckUtil::checkNotNull($this->searchChannels, "searchChannels");
        Taobao_RequestCheckUtil::checkMaxListSize($this->searchChannels, 10, "searchChannels");
    }
