 ...
 */
class Taobao_Request_TraderatesGetRequest
{
    /**
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkMaxValue($this->pageSize, 150, "pageSize");
        Taobao_RequestCheckUtil::checkMinValue($this->pageSize, 1, "pageSize");
        Taobao_RequestCheckUtil::checkNotNull($this->rateType, "rateType");
        Taobao_RequestCheckUtil::checkNotNull($this->role, "role");
    }
