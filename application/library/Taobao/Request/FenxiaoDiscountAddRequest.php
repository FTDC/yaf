 ...
 */
class Taobao_Request_FenxiaoDiscountAddRequest
{
    /**
     * 折扣名称,长度不能超过25字节
     **/
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkNotNull($this->discountName, "discountName");
        Taobao_RequestCheckUtil::checkNotNull($this->discountTypes, "discountTypes");
        Taobao_RequestCheckUtil::checkNotNull($this->discountValues, "discountValues");
        Taobao_RequestCheckUtil::checkNotNull($this->targetIds, "targetIds");
        Taobao_RequestCheckUtil::checkNotNull($this->targetTypes, "targetTypes");
    }
