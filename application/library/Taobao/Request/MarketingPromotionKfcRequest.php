 ...
 */
class Taobao_Request_MarketingPromotionKfcRequest
{
    /**
     * 活动描述
     **/
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkNotNull($this->promotionDesc, "promotionDesc");
        Taobao_RequestCheckUtil::checkNotNull($this->promotionTitle, "promotionTitle");
    }
