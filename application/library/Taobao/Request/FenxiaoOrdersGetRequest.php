 ...
 */
class Taobao_Request_FenxiaoOrdersGetRequest
{
    /**
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkMaxValue($this->pageNo, 2147483647, "pageNo");
        Taobao_RequestCheckUtil::checkMinValue($this->pageNo, -21474836478, "pageNo");
        Taobao_RequestCheckUtil::checkMaxValue($this->pageSize, 2147483647, "pageSize");
        Taobao_RequestCheckUtil::checkMinValue($this->pageSize, -21474836478, "pageSize");
        Taobao_RequestCheckUtil::checkMaxValue($this->purchaseOrderId, 9223372036854775807, "purchaseOrderId");
        Taobao_RequestCheckUtil::checkMinValue($this->purchaseOrderId, -9223372036854775808, "purchaseOrderId");
    }
