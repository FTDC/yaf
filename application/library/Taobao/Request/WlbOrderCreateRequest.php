 ...
 */
class Taobao_Request_WlbOrderCreateRequest
{
    /**
     * 支付宝交易号
     **/
	...
	public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkMaxLength($this->buyerNick, 64, "buyerNick");
        Taobao_RequestCheckUtil::checkNotNull($this->isFinished, "isFinished");
        Taobao_RequestCheckUtil::checkNotNull($this->orderItemList, "orderItemList");
        Taobao_RequestCheckUtil::checkNotNull($this->orderSubType, "orderSubType");
        ...
        Taobao_RequestCheckUtil::checkMaxLength($this->outBizCode, 128, "outBizCode");
        Taobao_RequestCheckUtil::checkMaxLength($this->remark, 4000, "remark");
        Taobao_RequestCheckUtil::checkNotNull($this->storeCode, "storeCode");
        Taobao_RequestCheckUtil::checkMaxLength($this->storeCode, 64, "storeCode");
        Taobao_RequestCheckUtil::checkMaxLength($this->tmsServiceCode, 64, "tmsServiceCode");
    }
