...
class Taobao_Request_WlbOutInventoryChangeNotifyRequest
{
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkNotNull($this->changeCount, "changeCount");
        Taobao_RequestCheckUtil::checkNotNull($this->itemId, "itemId");
        Taobao_RequestCheckUtil::checkNotNull($this->opType, "opType");
        Taobao_RequestCheckUtil::checkNotNull($this->outBizCode, "outBizCode");
        Taobao_RequestCheckUtil::checkNotNull($this->resultCount, "resultCount");
