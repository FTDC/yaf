 ...
 */
class Taobao_Request_JipiaoPolicyProcessRequest
{
    /**
     * 政策所支持的航空公司二字码
     **/
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkNotNull($this->airline, "airline");
        Taobao_RequestCheckUtil::checkMaxLength($this->airline, 2, "airline");
        Taobao_RequestCheckUtil::checkNotNull($this->arrAirports, "arrAirports");
        Taobao_RequestCheckUtil::checkMaxLength($this->arrAirports, 100, "arrAirports");
        Taobao_RequestCheckUtil::checkMaxLength($this->attributes, 300, "attributes");
        Taobao_RequestCheckUtil::checkNotNull($this->cabinRules, "cabinRules");
        Taobao_RequestCheckUtil::checkMaxLength($this->cabinRules, 300, "cabinRules");
        Taobao_RequestCheckUtil::checkMaxLength($this->changeRule, 300, "changeRule");
        Taobao_RequestCheckUtil::checkNotNull($this->dayOfWeeks, "dayOfWeeks");
        Taobao_RequestCheckUtil::checkMaxLength($this->dayOfWeeks, 7, "dayOfWeeks");
        Taobao_RequestCheckUtil::checkNotNull($this->depAirports, "depAirports");
        Taobao_RequestCheckUtil::checkMaxLength($this->depAirports, 100, "depAirports");
        Taobao_RequestCheckUtil::checkMaxLength($this->ei, 20, "ei");
        Taobao_RequestCheckUtil::checkMaxLength($this->excludeDate, 200, "excludeDate");
        Taobao_RequestCheckUtil::checkMaxValue($this->flags, 9223372036854775807, "flags");
        Taobao_RequestCheckUtil::checkMinValue($this->flags, 0, "flags");
        Taobao_RequestCheckUtil::checkMaxLength($this->flightInfo, 1000, "flightInfo");
        Taobao_RequestCheckUtil::checkMaxLength($this->memo, 500, "memo");
        Taobao_RequestCheckUtil::checkMaxLength($this->officeId, 32, "officeId");
        Taobao_RequestCheckUtil::checkMaxLength($this->outProductId, 64, "outProductId");
        Taobao_RequestCheckUtil::checkNotNull($this->policyType, "policyType");
        Taobao_RequestCheckUtil::checkMaxLength($this->refundRule, 300, "refundRule");
        Taobao_RequestCheckUtil::checkMaxLength($this->reissueRule, 300, "reissueRule");
        Taobao_RequestCheckUtil::checkNotNull($this->saleEndDate, "saleEndDate");
        Taobao_RequestCheckUtil::checkNotNull($this->saleStartDate, "saleStartDate");
        Taobao_RequestCheckUtil::checkMaxLength($this->seatInfo, 1500, "seatInfo");
        Taobao_RequestCheckUtil::checkMaxLength($this->specialRule, 300, "specialRule");
        Taobao_RequestCheckUtil::checkNotNull($this->travelEndDate, "travelEndDate");
        Taobao_RequestCheckUtil::checkNotNull($this->travelStartDate, "travelStartDate");
