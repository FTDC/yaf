 ...
 */
class Taobao_Request_FenxiaoProductSkuAddRequest
{
    /**
     * 代销采购价
     **/
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkMaxValue($this->quantity, 1000000, "quantity");
        Taobao_RequestCheckUtil::checkMinValue($this->quantity, 0, "quantity");
