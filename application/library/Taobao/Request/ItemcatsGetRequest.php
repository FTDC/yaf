 ...
 */
class Taobao_Request_ItemcatsGetRequest
{
    /**
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkMaxValue($this->parentCid, 9223372036854775807, "parentCid");
        Taobao_RequestCheckUtil::checkMinValue($this->parentCid, 0, "parentCid");
    }
