 ...
 */
class Taobao_Request_FenxiaoProductGradepriceUpdateRequest
{
    /**
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkMaxListSize($this->ids, 200, "ids");
        Taobao_RequestCheckUtil::checkNotNull($this->prices, "prices");
        Taobao_RequestCheckUtil::checkMaxListSize($this->prices, 200, "prices");
        Taobao_RequestCheckUtil::checkNotNull($this->productId, "productId");
        Taobao_RequestCheckUtil::checkNotNull($this->targetType, "targetType");
    }
