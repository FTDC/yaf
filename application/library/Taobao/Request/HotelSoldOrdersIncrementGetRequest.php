 ...
 */
class Taobao_Request_HotelSoldOrdersIncrementGetRequest
{
    /**
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkNotNull($this->endModified, "endModified");
        Taobao_RequestCheckUtil::checkNotNull($this->startModified, "startModified");
        Taobao_RequestCheckUtil::checkMaxLength($this->status, 1, "status");
    }
