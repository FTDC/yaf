 ...
 */
class Taobao_Request_TripJipiaoAgentOrderSpecialConfirmRequest
{
    /**
     * 能否支付
     **/
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkNotNull($this->canPay, "canPay");
        Taobao_RequestCheckUtil::checkMaxLength($this->failMemo, 200, "failMemo");
