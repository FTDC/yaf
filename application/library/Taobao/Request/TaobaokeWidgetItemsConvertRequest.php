 ...
 */
class Taobao_Request_TaobaokeWidgetItemsConvertRequest
{
    /**
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkMaxListSize($this->numIids, 50, "numIids");
        Taobao_RequestCheckUtil::checkMaxListSize($this->trackIids, 50, "trackIids");
    }
