 ...
 */
class Taobao_Request_HotelRoomQuotasQueryFeedbackRequest
{
    /**
     * 选中日期范围内的最大可用房量
     **/
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkNotNull($this->avaliableRoomCount, "avaliableRoomCount");
        Taobao_RequestCheckUtil::checkMinValue($this->avaliableRoomCount, 0, "avaliableRoomCount");
        Taobao_RequestCheckUtil::checkNotNull($this->checkinDate, "checkinDate");
        Taobao_RequestCheckUtil::checkNotNull($this->checkoutDate, "checkoutDate");
        Taobao_RequestCheckUtil::checkNotNull($this->messageId, "messageId");
        Taobao_RequestCheckUtil::checkNotNull($this->result, "result");
        Taobao_RequestCheckUtil::checkNotNull($this->totalRoomPrice, "totalRoomPrice");
        Taobao_RequestCheckUtil::checkMaxValue($this->totalRoomPrice, 99999999, "totalRoomPrice");
        Taobao_RequestCheckUtil::checkMinValue($this->totalRoomPrice, 0, "totalRoomPrice");
    }
