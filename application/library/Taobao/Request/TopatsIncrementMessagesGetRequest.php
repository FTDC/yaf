 ...
 */
class Taobao_Request_TopatsIncrementMessagesGetRequest
{
    /**
    ...
    public function check()
    {
        ...
        Taobao_RequestCheckUtil::checkNotNull($this->end, "end");
        Taobao_RequestCheckUtil::checkNotNull($this->start, "start");
        Taobao_RequestCheckUtil::checkNotNull($this->topics, "topics");
    }
