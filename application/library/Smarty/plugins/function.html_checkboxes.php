            ...
            case 'selected':
                if (is_array($_val)) {
                    ...
                    foreach ($_val as $_sel) {
                        if (is_object($_sel)) {
                            if (method_exists($_sel, "__toString")) {
                                ...
                                trigger_error(
                                    "html_checkboxes: selected attribute contains an object of class '".get_class(
                                        $_sel
                    ...
                    if (method_exists($_val, "__toString")) {
                        ...
                        trigger_error(
                            "html_checkboxes: selected attribute is an object of class '".get_class(
                                $_val
                            )."' without __toString() method",
                            E_USER_NOTICE
                        );
...
function smarty_function_html_checkboxes_output(
    ...
    if (is_object($output)) {
        if (method_exists($output, "__toString")) {
            ...
            trigger_error(
                "html_options: output is an object of class '".get_class($output)."' without __toString() method",
                E_USER_NOTICE
            );
