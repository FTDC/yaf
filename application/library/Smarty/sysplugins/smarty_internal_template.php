...
class Smarty_Internal_Template extends Smarty_Internal_TemplateBase
{
     ...
     * @returns string template content
     */
    public function setupInlineSubTemplate(
        $template,
        $cache_id,
        $compile_id,
        $caching,
    ...
    public function createTemplateCodeFrame($content = '', $cache = false)
    {
        ...
        if (!$this->source->recompiled) {
            $output .= "\$_valid = \$_smarty_tpl->decodeProperties(".var_export(
                    $this->properties,
                    true
                ).','.($cache ? 'true' : 'false')."); /*/%%SmartyHeaderCode%%*/?>\n";
    ...
    public function clearCache($exp_time = null)
    {
        ...
        return $this->cached->handler->clear(
            $this->smarty,
            $this->template_name,
            $this->cache_id,
            $this->compile_id,
    ...
    public function __get($property_name)
    {
        switch ($property_name) {
            ...
            case 'compiler':
                ...
                $this->compiler = new $this->source->compiler_class(
