...
class Smarty_Security
{
    ...
    {
        if (isset($this->php_functions) && (empty($this->php_functions) || in_array(
                    $function_name,
                    $this->php_functions
                ))) {
            return true;
    ...
    {
        if (isset($this->static_classes) && (empty($this->static_classes) || in_array(
                    $class_name,
                    $this->static_classes
                ))) {
            return true;
    ...
    {
        if (isset($this->php_modifiers) && (empty($this->php_modifiers) || in_array(
                    $modifier_name,
                    $this->php_modifiers
                ))) {
            return true;
    ...
    public function isTrustedModifier($modifier_name, $compiler)
    {
        ...
        if (empty($this->allowed_modifiers)) {
            ...
            if (in_array($modifier_name, $this->allowed_modifiers) && !in_array(
                    $modifier_name,
