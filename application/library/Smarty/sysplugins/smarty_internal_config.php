...
class Smarty_Internal_Config
{
    ...
    {
        return $this->compiled_filepath === null ? ($this->compiled_filepath = $this->buildCompiledFilepath(
    ...
    public function getCompiledTimestamp()
    {
        ...
        )) ? filemtime($this->getCompiledFilepath()) : false) : $this->compiled_timestamp;
    }
    ...
    {
        return $this->mustCompile === null ? $this->mustCompile = ($this->smarty->force_compile || $this->getCompiledTimestamp(
            ) === false || $this->smarty->compile_check && $this->getCompiledTimestamp(
            ) < $this->source->timestamp) : $this->mustCompile;
    }
