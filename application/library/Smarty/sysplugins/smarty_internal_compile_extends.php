...
class Smarty_Internal_Compile_Extends extends Smarty_Internal_CompileBase
{
    ...
    public function compile($args, $compiler)
    {
        ...
        if (preg_match_all("!({$this->_ldl}{$al}block\s(.+?)\s*{$this->_rdl})!", $_content, $s) != preg_match_all(
                "!({$this->_ldl}{$al}/block\s*{$this->_rdl})!",
                $_content,
                $c
            )) {
        ...
        while ($_start + 1 < $_result_count) {
            ...
            if (($this->mbstring_overload ? mb_substr(
                    ...
                    $_result[0][$_start][0],
                    0,
                    strlen($compiler->smarty->left_delimiter) + 1
            ...
            $_block_content = str_replace(
                ...
                '%%%%SMARTY_PARENT%%%%',
                ($this->mbstring_overload ? mb_substr(
                    $_content,
                    $_result[0][$_start][1] + mb_strlen($_result[0][$_start][0], 'latin1'),
                    $_result[0][$_start + $_end][1] - $_result[0][$_start][1] - +mb_strlen(
                        $_result[0][$_start][0],
                        'latin1'
                    ),
                    'latin1'
