...
class Smarty_Internal_Configfilelexer
{
    ...
    function yylex1()
    {
        ...
        do {
            if ($this->mbstring_overload ? preg_match(
                $yy_global_pattern,
                mb_substr($this->data, $this->counter, 2000000000, 'latin1'),
                $yymatches
                ...
                if ($r === null) {
                    $this->counter += ($this->mbstring_overload ? mb_strlen($this->value, 'latin1') : strlen(
                        $this->value
                    ));
                    ...
                    $this->line += substr_count($this->value, "\n");
                    if ($this->counter >= ($this->mbstring_overload ? mb_strlen($this->data, 'latin1') : strlen(
                            $this->data
                        ))) {
                        return false; // end of input
                    }
    ...
    function yy_r2_7($yy_subpatterns)
    {
        ...
        if (!$this->smarty->config_booleanize || !in_array(
