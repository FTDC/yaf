...
class Smarty_Internal_Configfileparser #line 79 "smarty_internal_configfileparser.php"
{
        ...
        do {
            ...
            if ($yyact >= self::YYNSTATE && $yyact < self::YYNSTATE + self::YYNRULE) {
                ...
                do {
                    ...
                    if (isset(self::$yyExpectedTokens[$nextstate]) && in_array(
                            $token,
    ...
    function yy_find_shift_action($iLookAhead)
    {
        ...
        if ($i < 0 || $i >= self::YY_SZ_ACTTAB || self::$yy_lookahead[$i] != $iLookAhead) {
            if (count(self::$yyFallback) && $iLookAhead < count(
                    self::$yyFallback
            ...
            if ($yyact < self::YYNSTATE) {
                ...
                if (self::YYERRORSYMBOL) {
                    ...
                    if ($yymx == self::YYERRORSYMBOL || $yyerrorhit) {
                        ...
                        while ($this->yyidx >= 0 && $yymx != self::YYERRORSYMBOL && ($yyact = $this->yy_find_shift_action(
                                self::YYERRORSYMBOL
                            )) >= self::YYNSTATE) {
                            $this->yy_pop_parser_stack();
                        }
