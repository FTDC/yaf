    ...
    BootstrapTable.prototype.initContainer = function () {
        this.$container = $([
            ...
            this.options.paginationVAlign === 'top' || this.options.paginationVAlign === 'both' ?
                '<div class="fixed-table-pagination" style="clear: both; padding-left: 20px; padding-right: 20px;"></div>' :
                '',
            ...
            this.options.paginationVAlign === 'bottom' || this.options.paginationVAlign === 'both' ?
                '<div class="fixed-table-pagination" style="padding-left: 20px; padding-right: 20px;"></div>' :
                '',
            '</div>',
            '</div>'
        ].join(''));
